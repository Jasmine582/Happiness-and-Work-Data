...
print(f"Countries with highest happiness scores: {happiness_average_per_country .nlargest(10)}")
print(f"Countries with the lowest happiness scores: {happiness_average_per_country.nsmallest(10)}")